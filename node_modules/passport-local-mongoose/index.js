...
module.exports = function(schema, options) {
  ...
  options.errorMessages.IncorrectPasswordError = options.errorMessages.IncorrectPasswordError || 'Username or password is incorrect';
  options.errorMessages.IncorrectUsernameError = options.errorMessages.IncorrectUsernameError || 'Username or password is incorrect';
